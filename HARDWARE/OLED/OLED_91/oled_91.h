...
#define OLED_91_SPI_SOFT_SCL_GPIO GPIOE
#define OLED_91_SPI_SOFT_SDA_GPIO GPIOE
#define OLED_91_SPI_SOFT_SCL_PIN GPIO_PIN_10
#define OLED_91_SPI_SOFT_SDA_PIN GPIO_PIN_11

#define OLED_91_SPI_SOFT_SCL_RESET HAL_GPIO_WritePin(OLED_91_SPI_SOFT_SCL_GPIO, OLED_91_SPI_SOFT_SCL_PIN, GPIO_PIN_RESET)
#define OLED_91_SPI_SOFT_SCL_SET HAL_GPIO_WritePin(OLED_91_SPI_SOFT_SCL_GPIO, OLED_91_SPI_SOFT_SCL_PIN, GPIO_PIN_SET)

#define OLED_91_SPI_SOFT_SDA_RESET HAL_GPIO_WritePin(OLED_91_SPI_SOFT_SDA_GPIO, OLED_91_SPI_SOFT_SDA_PIN, GPIO_PIN_RESET)
#define OLED_91_SPI_SOFT_SDA_SET HAL_GPIO_WritePin(OLED_91_SPI_SOFT_SDA_GPIO, OLED_91_SPI_SOFT_SDA_PIN, GPIO_PIN_SET)

#endif

// RES
#define OLED_91_RES_GPIO GPIOE
#define OLED_91_RES_PIN GPIO_PIN_12

// DC
#define OLED_91_DC_GPIO GPIOE
#define OLED_91_DC_PIN GPIO_PIN_13

// CS
#define OLED_91_CS1_GPIO GPIOE
#define OLED_91_CS1_PIN GPIO_PIN_14

#define ENABLE_OLED_91_RCC __HAL_RCC_GPIOE_CLK_ENABLE()
